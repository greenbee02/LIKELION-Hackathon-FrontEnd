 ...
 *
 * 기하는 `ProgressBar` 에서 그대로 물려받았다: 트랙 6pt, `radius.full`, 3단계 위에 9단계.
 * 같은 앱에서 "채워진 길이"가 두 가지 모양을 가질 이유가 없고, 다른 점은 여기에 잡을 것이
 * 하나 붙는다는 것뿐이다. 노브는 `solidStrong` — 잡는 것은 채움보다 진해야 손이 간다.
 *
