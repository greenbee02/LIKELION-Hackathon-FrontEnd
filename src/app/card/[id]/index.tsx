 ...
 *
 * **The reverse side carries the product summary.** The full product screen remains available
 * through the explicit button below the card for longer descriptions and additional information.
 *
 ...
 *
 * `Screen gutter={false}` with the gutter carried by the scroll content, because the card and its
 * actions are one scrolling surface.
 *
    ...
    <Screen gutter={false}>
      ...
      >
        ...
        <Button
          ...
          variant="outline"
          onPress={() =>
            router.push({ pathname: '/catalog/products/[id]', params: { id: product.id } })
          }
...
const styles = StyleSheet.create({
  /* The screen's 16pt gutter lives on the scroll content so the card and its actions share one
     aligned surface. */
  ...
  productDetails: { marginTop: space[3] },
